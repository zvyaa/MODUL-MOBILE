...
import com.example.mycomicappxml.databinding.ItemComicHighlightBinding
...
class ComicHighlightAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = ItemComicHighlightBinding.inflate(LayoutInflater.from(parent.context), parent, false)
